...
public class AccuWeatherProvider implements WeatherProvider {
    ...
    public void getWeather(Periods periods) throws IOException {
        ...
        if (periods.equals(Periods.FIVE_DAYS)) {
            ...
            List<WeatherByDays> WeatherList = objectMapper.readValue(jacksonNew, new TypeReference<>() {
            });
            WeatherList.forEach(x -> System.out.println("На дату: " +x.getDate() + " " + x.getDay().getIconPhrase()+ " "+x.getNight().getIconPhrase() +"\n"  +" Минимум: " + x.getTemperature().getMinimum().getValue() + " Максимум:" +x.getTemperature().getMaximum().getValue()));
        ...
        if (periods.equals(Periods.NOW)) {
            ...
            WeatherClass weather = objectMapper.readValue(jacksonNew,WeatherClass.class);
            System.out.println(weather.getWeatherText() + " в градусах это " + weather.getTemperature().getMetric().getValue() + "C");
        }
    }
